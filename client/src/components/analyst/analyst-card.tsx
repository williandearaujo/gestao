...
export function AnalystCard({ analyst, userRole, onEdit, onViewHistory }: AnalystCardProps) {
  ...
  // [3.1] Exibição do Cargo e Senioridade separadamente
  const positionText = `${analyst.role || "Cargo não definido"} • ${analyst.seniority || "Nível não definido"}`;
    ...
    <Card className="hover:shadow-md transition-shadow">
      <CardContent className="p-6">
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">{positionText}</p>
            </div>
          </div>
        ...
        <div className="space-y-2 text-sm">
          ...
          {/* [5] SALÁRIO - VISÍVEL SÓ P/ ADMIN/MANAGER */}
          {canViewSalary && (
